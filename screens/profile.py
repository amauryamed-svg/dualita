        ...
        controls=[
            ...
            ft.Container(
                content=ft.Column([
                    ...
                    ft.Row([
                        ft.Image(src="/swisscontact_logo.png", width=110, height=32, fit=ft.ImageFit.CONTAIN),
                        ft.Container(width=1, height=20, bgcolor=BORDER_SUBTLE),
                        ft.Image(src="/caua_logo.png", width=70, height=32, fit=ft.ImageFit.CONTAIN),
